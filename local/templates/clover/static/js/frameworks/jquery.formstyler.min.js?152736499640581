		...
		init: function() {
			...
			// file
				...
				var fileOutput = function() {
					...
					if(el.attr('file-name') != undefined){
						browse = el.attr('file-name');
					}
					var file =
						$('<div class="jq-file">' +
			...
			// select
				...
				var selectboxOutput = function() {
					...
					function doSelect() {
						...
						var custom_class = el.attr('custom-class') != undefined ? el.attr('custom-class') : '';
						var selectbox =
							$('<div class="jq-selectbox jqselect '+custom_class+'">' +
